...
const AccordianlistWhite = ({ faqsList }) => {
  ...
  return (
    ...
    >
      ...
      ${
        state ? "text-FM-orange" : "text-white"
      ...
      >
        ...
        {state ? (
          <svg
            ...
            className="h-5 w-5 text-white hover:text-FM-orange ml-2"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 text-white ml-2 hover:text-FM-orange"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
  ...
  return (
    <section className="leading-relaxed max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="max-w-2xl mx-auto">
        {faqsList.map((item) => (
          <AccordianlistWhite key={item.a} faqsList={item} />
        ))}
      </div>
    </section>
  );
